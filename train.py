...
def main():
    ...
    generator = Generator(vocab_size, args.hidden_units, args.embedding_size)
    ...
    train(generator, pretrain, loss_fn, optimizer, epochs=args.pretrain_epochs)
    train(generator, dataset, loss_fn, optimizer, epochs=args.epochs)
